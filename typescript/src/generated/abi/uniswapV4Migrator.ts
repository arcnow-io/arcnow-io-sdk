// GENERATED from abi/UniswapV4Migrator.json at the repository root - do not edit.
// Pinned to arcnow-io/contracts; see pins.json.

/**
 * ABI of the arcnow.io `UniswapV4Migrator` contract.
 *
 ...
 */
export const uniswapV4MigratorAbi = [
  {
    "type": "constructor",
    "inputs": [
      {
  ...
  {
    "type": "event",
    "name": "UniswapV4MigratorDeployed",
    "inputs": [
      {
        "name": "curveFactory",
        "type": "address",
