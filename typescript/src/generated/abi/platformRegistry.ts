// GENERATED from abi/PlatformRegistry.json at the repository root - do not edit.
// Pinned to arcnow-io/contracts; see pins.json.

/**
 * ABI of the arcnow.io `PlatformRegistry` contract.
 *
...
export const platformRegistryAbi = [
  ...
  {
    "type": "event",
    "name": "ProtocolAdminTransferStarted",
    "inputs": [
      {
        "name": "currentAdmin",
        "type": "address",
  ...
  {
    "type": "error",
    "name": "PlatformAlreadyDeregistered",
    "inputs": [
      {
        "name": "platform",
        "type": "address",
